...
export class RNScrollView extends React.PureComponent<RNScrollViewPropType> {
    ...
    constructor(props: RNScrollViewPropType) {
        super(props);
    ...
    scrollTo(offset: Offset, animated: boolean = true) {
        if (Platform.OS === "ios") {
            NativeModules.RNScrollView.scrollTo(
    ...
    endRefresh() {
        if (Platform.OS === "ios") {
            NativeModules.RNScrollView.endRefresh(findNodeHandle(this._scrollView));
        } else if (Platform.OS === "android") {
    ...
    endLoading() {
        if (Platform.OS === "ios") {
            NativeModules.RNScrollView.endLoading(findNodeHandle(this._scrollView));
        } else if (Platform.OS === "android") {
...
const RNScrollViewNative = Animated.createAnimatedComponent(
    requireNativeComponent("RNScrollView", RNScrollView)
);
